...
STUB_B_MASS = 86.00307                # alkene fragment  (was 85.98264)
DELTA_NEUT  = STUB_B_MASS - STUB_A_MASS   # 31.99251 Da  (was 31.97208)

STUB54_RE  = re.compile(r'\(54\.010')
STUB86_RE  = re.compile(r'\(86\.003')      # regex adjusted to new mass
